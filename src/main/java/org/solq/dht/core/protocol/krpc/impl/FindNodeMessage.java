...
public class FindNodeMessage extends CommonMessage {
	...
	public byte[] toRequestMessage() {
		...
		message.put(KRPCProtocol.HEARD_T, DHTUtils.randomToString(2));
		...
		body.put(KRPCProtocol.HEARD_ID, DHTUtils.randomToString(10));
		body.put(KRPCProtocol.HEARD_TARGET, DHTUtils.randomToString(10));
